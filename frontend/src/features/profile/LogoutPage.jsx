...
export default function LogoutPage() {
  ...
  return (
    <DashboardLayout pageTitle="Logout">
      <div className="mf-detail-card" style={{ maxWidth: "500px", margin: "40px auto", minHeight: "auto" }}>
        <div className="mf-logout-box">
          <div style={{ width: "60px", height: "60px", borderRadius: "50%", backgroundColor: "#FEE2E2", color: "#EF4444", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "28px", marginBottom: "8px" }}>
            ⚠️
          </div>
          ...
          <button onClick={() => navigate(-1)} className="mf-logout-btn-cancel">Cancel and Go Back</button>
        </div>
      </div>
    </DashboardLayout>
  );
